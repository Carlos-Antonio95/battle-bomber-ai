...
def avaliar_genes(genes_por_jogador):
    ...
    total_suicidios = {j: 0 for j in JOGADORES}
    total_recompensa_q = {j: 0 for j in JOGADORES}
    ...
    for _ in range(PARTIDAS_POR_GENE):
        ...
        suicidios = resultado.get("suicidios", [0, 0, 0, 0])
        recompensas_q = resultado.get("q_learning_recompensas", [0, 0, 0, 0])
        ...
        for jogador in JOGADORES:
            ...
            total_suicidios[jogador] += suicidios[index]
            total_recompensa_q[jogador] += recompensas_q[index]
    ...
    for jogador in JOGADORES:
        ...
        suicidios_total = total_suicidios[jogador]
        recompensa_q_total = total_recompensa_q[jogador]
        ...
        fitness -= suicidios_total * 1200
        fitness += recompensa_q_total * 0.5
        ...
        avaliacoes[jogador] = {
            ...
            "mortes": mortes_total,
            "suicidios": suicidios_total,
            "recompensa_q": recompensa_q_total,
            "fitness": fitness
        }
    ...
    for geracao in range(1, GERACOES + 1):
        ...
        for jogador in JOGADORES:
            ...
            historico.append({
                ...
                "suicidios": melhor["suicidios"],
                "recompensa_q": melhor["recompensa_q"],
